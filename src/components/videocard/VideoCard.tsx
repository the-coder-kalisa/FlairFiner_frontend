        ...
        <div className="absolute bottom-0 left-0 w-full bg-gray-800 bg-opacity-90 rounded-b-none">
          <div className="flex items-center justify-center space-x-20">
            ...
            <div className="flex items-center">
              <span className="text-gray-400 focus:outline-none text-sm mr-1">{video.likes}</span>
              <button
                className={`text-xl focus:outline-none hover:text-green-300 ${
            ...
            {/* Dislikes */}
            <div className="flex items-center">
              <span className="text-gray-400 focus:outline-none text-sm mr-1">
                {video.dislikes}
              </span>
              <button
                className={`text-xl focus:outline-none hover:text-red-300 ${
            ...
            <div className="flex items-center">
              ...
              <button
                className="text-xl focus:outline-none text-yellow-400 hover:text-yellow-300"
              ...
              <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-60">
                <div className="bg-white p-4 rounded-md shadow-lg">
                  <h2 className="text-lg font-semibold">
                    Pay to Send Golden Buzzer
                  </h2>
                  <p className="mb-4 text-gray-600">
                    Pay $10 to send a Golden Buzzer.
                  </p>
                  <div className="flex justify-end">
                    <button
                      className="px-3 py-1 text-xs focus:outline-none bg-yellow-500 text-white rounded-sm hover:bg-yellow-600"
                      onClick={handlePayment}
                    >
                      Pay $10
                    </button>
                    <button
                      className="ml-2 px-3 py-1 text-xs focus:outline-none text-gray-500 hover:text-gray-700"
