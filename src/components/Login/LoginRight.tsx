...
const LoginRight=()=> {
  ...
  return (
    ...
    <div className='leading-6 mx-auto w-[85%] '>
      <h1 className='text-black text-lg lg:font-bold py-4 '>Login to <span className='text-[#8F0A0A]'>FlairFiner</span>
      </h1>
    ...
    <div className='mx-auto w-[85%] pt-3 flex flex-col justify-evenly h-[40%] gap-4'>
      ...
      <div className='w-[85%] h-fit relative flex items-center justify-end'>
        ...
        <div className='w-[85%] pl-4 text-[#8F0A0A]'>
            Forgot password?
        </div>
    ...
    <div className='w-[85%] mx-auto flex justify-center inset-x-0 h-[80%]'>
      <div className='w-full flex justify-end'>
        ...
        <section className='w-[85%] self-center bg-transparent'>Don't have an account?  <Link to='/signup' className='text-[#8F0A0A]'>  Sign up</Link></section>
      </div>
    </div>
  </div>
  )
